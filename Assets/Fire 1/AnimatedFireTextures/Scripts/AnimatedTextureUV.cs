...
public class AnimatedTextureUV : MonoBehaviour
{
	...
	void SetSpriteAnimation(int colCount ,int rowCount ,int rowNumber ,int colNumber,int totalCells,int fps )
	{
		...
		// Size of every cell
		float sizeX = 0.1f;// 1.0f / colCount ; // We split the texture in 4 rows and 4 cols
		float sizeY = 0.35f;// 1.0f / rowCount ;
		...
		Debug.Log(offsetX + " -UIndex: " + uIndex + " -colsize: " + colNumber);
